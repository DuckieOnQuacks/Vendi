        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildTextInput('Building Name*', _buildingController,
                  'Ex: Davidson Building',
                  maxLength: 25),
              const SizedBox(height: 16.0),
              _buildTextInput('Floor Number*', _floorController, 'Ex: 2',
                  maxLength: 3),
              const SizedBox(height: 20.0),
              ...
              Row(
                ...
                children: [
                  _buildMachineTypeCard(
                      Icons.fastfood, 'Snack', _isSnackSelected, () {
                    setState(() {
                  ...
                  _buildMachineTypeCard(
                      Icons.local_drink, 'Beverage', _isDrinkSelected, () {
                    setState(() {
                  ...
                  _buildMachineTypeCard(
                      Icons.inventory, 'Supply', _isSupplySelected, () {
                    setState(() {
                      _isSnackSelected = false;
                      _isDrinkSelected = false;
                                  ...
                                  ElevatedButton(
                                    onPressed: () async {
                                      ...
                                      showConfettiDialog(context,
                                          "Congratulations you\'ve earned 30 vendi points!");
                                    },
                                    style: ElevatedButton.styleFrom(
                                      foregroundColor: Colors.white,
                                      backgroundColor: Theme.of(context)
